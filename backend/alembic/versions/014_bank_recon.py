...
def upgrade() -> None:
    ...
    op.create_index("ix_bank_transactions_administration_id", "bank_transactions", ["administration_id"])
    ...
    op.create_index("ix_reconciliation_actions_administration_id", "reconciliation_actions", ["administration_id"])
    op.create_index("ix_reconciliation_actions_bank_transaction_id", "reconciliation_actions", ["bank_transaction_id"])
    op.create_index("ix_reconciliation_actions_accountant_user_id", "reconciliation_actions", ["accountant_user_id"])
