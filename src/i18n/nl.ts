...
export const nl = {
  ...
  auth: {
    ...
    createAccount: "Maak je gratis account aan",
    email: "E-mailadres",
    password: "Wachtwoord",
    ...
    loginDescription: "Log in op je ZZPers Hub dashboard",
    registerDescription: "Start binnen 60 seconden — gratis, geen creditcard nodig",
    role: "Rol",
  ...
  zzpExpenses: {
    ...
    scanReceipt: "Foto toevoegen",
    scanning: "Uploaden...",
    reviewScannedExpense: "Uitgave toevoegen",
    newExpenseDescription: "Voeg een nieuwe zakelijke uitgave toe.",
    editExpenseDescription: "Wijzig de gegevens van deze uitgave.",
    reviewScannedDescription: "Vul de gegevens van de uitgave in.",
    scanSuccess: "Foto toegevoegd. Vul het formulier in.",
    // Table columns
    columnDate: "Datum",
    ...
    // Categories (mapped to backend category keys)
    category_algemeen: "Algemeen",
    category_kantoor: "Kantoorkosten",
    category_transport: "Reiskosten",
    category_marketing: "Marketing",
    category_hardware: "Hardware",
    category_software: "Software & IT",
    category_opleiding: "Opleiding",
    category_huisvesting: "Huisvesting",
    category_telefoon: "Telefoon & internet",
    category_internet: "Internet",
    category_overig: "Overige kosten",
    category_Abonnement: "Abonnementen",
    category_Lease: "Lease",
    category_Lening: "Lening",
    ...
    category_representatie: "Representatiekosten",
    // Filter
  ...
  dashboard: {
    ...
    // ZZP-focused metrics (new)
    openInvoices: "Openstaande facturen",
    openInvoicesCount: "{count} facturen",
    openInvoicesDescription: "Verstuurde en te late facturen",
    paidThisMonth: "Betaald deze maand",
    paidThisMonthDescription: "Ontvangen betalingen in {month}",
    expensesThisMonth: "Uitgaven deze maand",
    expensesThisMonthDescription: "Kosten in {month}",
    hoursThisWeek: "Uren deze week",
    hoursThisWeekDescription: "{billable}u factureerbaar",
    btwEstimate: "BTW schatting",
    btwEstimateDescription: "{quarter} - nog {days} dagen",
    btwToPayLabel: "Te betalen",
    btwCollectedLabel: "Ontvangen",
    btwDeductibleLabel: "Voorbelasting",
    btwCollectedFrom: "Ontvangen van facturen",
    btwDeductibleFrom: "Voorbelasting van uitgaven",
    daysUntilDeadline: "Nog {days} dagen tot de deadline",
    actionsNeeded: "Acties nodig",
  ...
  settings: {
    ...
    bankConnectionDescription: "Koppel je bankrekening om automatisch transacties te importeren via PSD2.",
    bankConnected: "Verbonden met",
    bankLastSync: "Laatst gesynchroniseerd",
    bankSync: "Synchroniseren",
    bankConnect: "Koppel je bank",
    bankSelectBank: "Selecteer je bank",
    bankLoadingInstitutions: "Banken laden...",
    bankConnectError: "Bankkoppeling mislukt",
    bankSyncError: "Synchronisatie mislukt",
    bankSyncSuccess: "transacties geïmporteerd",
    logoUrl: "Logo URL",
