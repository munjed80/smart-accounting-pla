...
class ZZPTimeEntry(Base):
    ...
    - customer_id: Optional reference to customer
    - hourly_rate_cents: Optional hourly rate for billing
    - billable: Whether this time is billable
    - invoice_id: Reference to invoice if entry has been invoiced
    - is_invoiced: Boolean flag indicating if entry is invoiced
    """
