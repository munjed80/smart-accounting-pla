 ...
 * 
 * Premium empty-state shell page for upcoming time tracking feature.
 */
...
export const ZZPTimeTrackingPage = () => {
  const features = [
    { icon: Clock, text: t('zzpTimeTracking.feature1') },
    { icon: Timer, text: t('zzpTimeTracking.feature2') },
    { icon: CalendarCheck, text: t('zzpTimeTracking.feature3') },
    { icon: Receipt, text: t('zzpTimeTracking.feature4') },
    { icon: Export, text: t('zzpTimeTracking.feature5') },
  ]
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        ...
        <Card className="bg-card/80 backdrop-blur-sm border-2 border-dashed border-primary/20">
          <CardContent className="flex flex-col items-center justify-center py-12 sm:py-16 text-center px-4">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('zzpTimeTracking.comingSoon')}</h3>
            <p className="text-muted-foreground mb-8 max-w-md">
              {t('zzpTimeTracking.comingSoonDescription')}
            </p>
            ...
            <div className="w-full max-w-sm bg-secondary/30 rounded-xl p-4 border border-border/50">
              <h4 className="text-sm font-semibold mb-3 text-left">
                {t('zzpTimeTracking.plannedFeatures')}
              </h4>
